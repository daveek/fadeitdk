 ...
 *
*/
include "../vendor/abraham/twitteroauth/twitteroauth/twitteroauth.php";
include "keys.php";
...
$tweets = $authObj->get('https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=fadeitdk&count=5');
