...
function rootConfig($locationProvider, $urlRouterProvider, $stateProvider, $translateProvider){
  ...
  $translateProvider.translations('en', {
    ...
    "EXPERTISE_CKAN_DEVELOPMENT": "Openness and transparency is the key to the government that you want. If you are looking to build or extend an Open Data site, we’re here to help. We have experience with building large <a href=\"http://ckan.org\">CKAN</a> portals complete with Drupal integration.",
