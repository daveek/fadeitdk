...
function rootConfig($locationProvider, $urlRouterProvider, $stateProvider, $translateProvider){
  ...
  $translateProvider.translations('en', {
    ...
    "EXPERTISE_DRUPAL_DEVELOPMENT": "Planning a medium to large size, highly-customizable modern website with awesome community support? Looks like you're talking about Drupal. We can build a custom installation profile, theme or module for you. Also, we can provide you with Drupal site maintenance, testing and support.<h2>Why we like <a href=\"https://www.drupal.org\" target=\"_blank\">Drupal</a>?</h2>Drupal takes \"One size fits all\" approach for content management and web based systems. Due to the flexibility of the platform it has a steeper learning curve, but it's worth it. Drupal can serve simple blogs, complex web shops and custom enterprise grade systems alike. It is the default choice for governments and other institutions where security and scalability is essential.<h2>Notable websites running Drupal:</h2><ul><li><a href=\"https://www.whitehouse.gov\" target=\"_blank\">https://www.whitehouse.gov</a></li><li><a href=\"http://www.warnerbros.com\">http://www.warnerbros.com</a></li><li><a href=\"http://www.edelegationen.se\" target=\"_blank\">http://www.edelegationen.se</a></li><li><a href=\"http://www.cvr.dk\">http://www.cvr.dk</a></li></ul>",
    "EXPERTISE_PYTHON_DEVELOPMENT": "Sometimes Content Management Systems just don't cut it. At fadeit, we love Python and its Web Stack and we can build custom web apps using Flask micro framework.<h2>Why we like <a href=\"http://flask.pocoo.org\" target=\"_blank\">Flask</a>?</h2>Flask is a microframework for web applications written in Python. It is called microframework because it does not presume or force a developer to use a particular tool or library. We like freedom of choice, because then we get to make best decisions for a specific scenario. Flask itself is very light-weight, however, due to it's popularity, there is an extension out there for just about any common use-case. Flask is fast to get started with - check our blog posts where we have written about working Flask applications with just under 40 lines of code <a href=\"http://fadeit.dk/blog/post/python3-flask-pil-in-memory-image\" target=\"_blank\">here</a> and <a href=\"http://fadeit.dk/blog/post/managing-angular-translate-translations\" target=\"_blank\">here</a><h2>Notable websites running Flask:</h2><ul><li><a href=\"https://www.pinterest.com\" target=\"_blank\">Pinterest</a></li><li><a href=\"https://www.reddit.com\" target=\"_blank\">Reddit</a></li><li><a href=\"https://www.twilio.com\" target=\"_blank\">Twilio</a></li></ul>",
    "EXPERTISE_ANGULARJS_DEVELOPMENT": "Abstracting the front-end will allow you to develop scalable, maintainable and reusable applications. Single page apps will also drastically simplify the server side logic and improve the performance of the interface.<h2>Why we like <a href=\"https://angularjs.org\" target=\"_blank\">Angular</a>?</h2>Single Page Applications (SPAs) is one of the hot topics in web development these days. By eliminating full page reloads and doing all the heavy-lifting behind the scenes, in your browser, they make user experience so much better. It just feels right and we don’t want to look back!<br/>Backed by Google, AngularJS popularity has <a href=\"https://www.google.com/trends/explore#q=angularjs%2C%20Ember%20JS%2C%20Backbone%20JS%2C%20%2Fm%2F0fs46gx&cmpt=q&tz=\" target=\"_blank\">sky-rocketed</a> and it is here to stay. AngularJS is the most popular framework for building this kind of applications, it has a huge community of developers and countless modules built for it. A worthwile mention is <a href=\"http://ionicframework.com\" target=\"_blank\">Ionic Framework</a> which allows porting Angular based applications into mobile apps - build once, deploy everywhere!<h2>Angular in action?</h2><ul><li>This very website! (take a look around)</li><li><a href=\"https://hopper.dk\" target=\"_blank\">Hopper.dk</a></li><li><a href=\"http://www.msnbc.com\" target=\"_blank\">MSNBC</a></li><li><a href=\"https://www.virginamerica.com\" target=\"_blank\">Virgin America</a></li><li><a href=\"http://angularjs.blogspot.dk/2012/08/your-excuse-to-buy-playstation.html\" target=\"_blank\">Youtube for Playstation 4</a></li></ul>",
    "EXPERTISE_IT_AUTOMATION_TITLE": "IT Automation",
    "EXPERTISE_IT_AUTOMATION": "Perhaps you've heard some legends about IT companies where new developers are able to commit code on their very first day and push to production on their first week? Well, it's not a miracle and it's possible to achieve this in your company too. We embrace DevOps and Infrastructure as Code mentality. Give us a call if you need a dedicated automation ninja to help you with Puppet, Docker or Vagrant.<h2>Why we like <a href=\"https://puppetlabs.com\" target=\"_blank\">Puppet</a>?</h2>Know that feeling when you get a new computer and have to install all the programs again?  Office suite, email client, browser, antivirus, etc… It’s really frustrating. This happens every time a new employee is hired or a server is set up. Installing, configuring and testing can take better part of the day - for us it would take about 5-6 hours to set up our production server. Meanwhile, it takes 22 minutes for Puppet to do the same thing (and you can have coffee while it's running).<br/>Another common problem for developers is maintaining a secure and consistent environment. Imagine that I install component X (e.g. MySQL database) and write a piece of code that is using newly installed component. Now I have to install the same component again on production server and tell every other developer to install it, or the code will break.<br/>The incredible pain of setting up and maintaining development environments pushes developers to ignore security policies, do redundant work and focus on the stuff that they weren’t hired for. At fadeit, we made a decision not to go through this hell and that is why we automate most everything about our systems with Puppet.",
    ...
    "EXPERTISE_CKAN_DEVELOPMENT": "Openness and transparency is the key to the government that you want. If you are looking to build or extend an Open Data site, we’re here to help. We have experience with building large <a href=\"http://ckan.org\" target=\"_blank\">CKAN</a> portals complete with Drupal integration.",
    "EXPERTISE_NODEJS_TITLE": "NodeJS Development",
    "EXPERTISE_NODEJS_DEVELOPMENT": "Javascript no longer runs in the browser - NodeJS offers concurrency model suitable for web applications dealing with data in real-time. We develop communications applications with socket.io, custom modules for most popular Internet of Things routing software <a href=\"http://nodered.org\">Node-RED</a> and lightweight <a href=\"http://expressjs.com\" target=\"_blank\">express.js</a> backends.",
     ...
     */
    "SEO_TITLE_APPEND": "fadeit - software development company in Aarhus, Denmark",
    "SEO_LOGO_ALT": "the fadeit logo - software development company in Aarhus, Denmark",
    "SEO_LEGO_STRUCTURE_ALT": "the structure of the fadeit logo - software development company in Aarhus, Denmark",
    "SEO_ARROW_DOWN_ALT": "continue reading about fadeit - software development company in Aarhus, Denmark",
    "SEO_HEART_ALT": "Thanks for your time, lots of <3 from fadeit - software development company in Aarhus, Denmark",
    "SEO_PROJECT_ALT": " - project made by fadeit - software development company",
    "SEO_META_DESC": "fadeit is a software development company from Aarhus, Denmark. We conceptualize, develop and design software, web or mobile applications. The technologies we have experienced with are Python, AngularJS, Drupal, node.js, CKAN just to name a few.",
    "SEO_DESC_APPEND": "Software, web and mobile development in Aarhus, with technologies such as Python, Node.js or AngularJS.",
    "SEO_SCREENSHOT_ALT": " - screenshot made by fadeit - software development company in Aarhus, Denmark"
  });
  ...
  $translateProvider.translations('da', {
    ...
    "FRONT_SOFTWARE_SECURE_TEXT": "Det kan være svært en kunde at se hvad der sker bag ved skærmen ... <br/>Hvad nytter det at man kører rundt i verdens smukkeste bil, hvis ikke den kan <br/>bremse? <br/><br/>Det er opgave at sikre at visse regler overholdes når vi udvikler <br/>software til vores kunder. For at sikre at vi ikke går på kompromis med vores <br/>regelsæt har vi som udgangspunkt altid manuelle og automatiske afprøvnings- <br/>procedurer på plads. <br/><br/>Det er måske også årsagen til at vi ikke er de billigste ... men det giver dig en garanti <br/>for at dit software er stabilt, at sikkerhed ikke kompromitteret og at, hvis <br/>det skulle fejle, så kan fejl lokaliseres og fjernes hurtigt og effektivt.",
    ...
    "EXPERTISE_DRUPAL_DEVELOPMENT": "Planlægger du at bygge en moderne hjemmeside med mulighed for at integration? Så taler vi om Drupal. Fadeit har arbejdet med Drupal de seneste mange år og har tons af kompetancer med customiserede installations profiler, tema eller moduler. Derudover tilbyder vi også vedligeholdelse, fejlfinding og support af Drupal.<h2>Derfor elsker vi <a href=\"https://www.drupal.org/\" target=\"_blank\">Drupal</a>?</h2>Drupal er et udviklet \"One Size Fits All\" CMS og hjemmeside. Grundet Drupal’s store fleksibilitet kræver det også mere af manden bag skærmen, men det er indsatsen og tiden værd mange gange. Drupal kan virke som en simpel blog, avanceret webshop, lækker hjemmeside eller et backoffice. Drupal er i dag det fortrukne valg af regeringer, stater og andre institutioner hvor sikkerhed og skablérbarhed er i højsæde.<h2>Hjemmesider der benytter Drupal</h2><ul><li><a href=\"https://www.whitehouse.gov\" target=\"_blank\">https://whitehouse.gov</a></li><li><a href=\"http://www.warnerbros.com\" target=\"_blank\">http://warnerbros.com</a></li><li><a href=\"http://www.edelegationen.se\" target=\"_blank\">http://www.edelegationen.se</a></li><li><a href=\"http://www.cvr.dk\" target=\"_blank\">http://www.cvr.dk</a></li></ul>",
    "EXPERTISE_PYTHON_DEVELOPMENT": "Nogle gange er CMS systemer bare ikke nok. Hos fadeit elsker vi Python og dens Web Stack - her kan vi bygge custom web applikationer ved brug af Flask micro framework.<h2>Derfor elsker vi <a href=\"http://flask.pocoo.org\" target=\"_blank\">Flask</a>?</h2>Flask er et microframework for web applikationer skrevet i Python. Man bruger termen microframework fordi det ikke tvinger en udvikler til at skulle bruge et specifikt værktøj eller bibliotek - Vi elsker friheden til at vælge, forbi det betyder at vi kan tage de rette valg til en specifik opgave. Flask er ret simpel i sig selv, men grundet populariteten og hypen omkring Flask findes der en udvidelse til næsten en hvilken som helst formål. Man kommer hurtigt i gang med Flask - tjek vores blog, hvor vi har skrevet om at arbejde med Flask applikationer med bare 40 liniers kode <a href=\"http://fadeit.dk/blog/post/python3-flask-pil-in-memory-image\" target=\"_blank\">her</a> og <a href=\"http://fadeit.dk/blog/post/managing-angular-translate-translations\" target=\"_blank\">her</a>.<h2>Hjemmesider der benytter Flask:</h2><ul><li><a href=\"https://www.pinterest.com\" target=\"_blank\">Pinterest</a></li><li><a href=\"https://www.reddit.com\" target=\"_blank\">Reddit</a></li><li><a href=\"https://www.twilio.com\" target=\"_blank\">Twilio</a></li></ul>",
    "EXPERTISE_ANGULARJS_DEVELOPMENT": "Generalisering af din front-end vil give dig mulighed for at udvikle skalerbare, vedligeholdelsesvenlig og genanvendelige applikationer. Enkelt side apps vil ligeledes forenkle server logikken og forbedre effektiviteten af din grænseflade.<h2>Derfor elsker vi <a href=\"https://angularjs.org/\" target=\"_blank\">Angular</a>?</h2>Single Page Applications (SPA’s) er en af de mest omtalte teknologier i webudvikling disse dage. Ved at eliminere at hele sider genindlæses sikrer man at alt det tunge arbejde sker bag kulisserne, i din browser, det gør brugeroplevelsen meget hurtigere og mere intuitiv.Med opbakning fra Google har AngularJS eksploderet i popularitet, og er kommet for at blive. AngularJS er det mest populære framework for opbygning af dens form for programmer, der findes et enormt fællesskab af udviklere og utallige moduler der er bygget af samme grundlag. Det er værd at nævne at Ionic Framework, som sikrer konvertering af Angular baserede applikationer til mobile apps - du bygger det én gang, bruger det overalt!<h2>Live Angular?</h2><ul><li>Denne hjemmeside! (kig dig omkring)</li><li><a href=\"https://hopper.dk\" target=\"_blank\">Hopper.dk</a></li><li><a href=\"http://www.msnbc.com\" target=\"_blank\">MSNBC</a></li><li><a href=\"https://www.virginamerica.com\" target=\"_blank\">Virgin America</a></li><li><a href=\"http://angularjs.blogspot.dk/2012/08/your-excuse-to-buy-playstation.html\" target=\"_blank\">Youtube for Playstation 4</a></li></ul>",
    "EXPERTISE_IT_AUTOMATION_TITLE": "IT Automatisering",
    "EXPERTISE_IT_AUTOMATION": "Måske har du hørt legender om IT-virksomheder, hvor nye udviklere er i stand til at udvikle kode på deres allerførste dag, og udgive samme til produktion i deres første uge? Tja, det er ikke et mirakel, og det er muligt at opnå dette i din virksomhed også. Vi arbejder med DevOps og infrastruktur som kode mentalitet. Giv os et opkald, hvis du har brug for en dedikeret automation ninja til at hjælpe dig med Puppet, Docker eller Vagrant.<h2>Derfor elsker vi <a href=\"https://puppetlabs.com\" target=\"_blank\">Puppet</a>?</h2>Kender du følelsen, når du får en ny computer, og er nødt til at installere alle programmer igen? Office-pakke, e-mail klient, browser, antivirus, osv ... Det er virkelig frustrerende. Det sker hver gang en ny medarbejder ansættes eller en server skal konfigureres. Installation, konfiguration og test kan tage hele dagen - for os, ville det tage omkring 5-6 timer at oprette vores produktion server. I mellemtiden tager det kun 22 minutter for Puppet at gøre det samme (og du kan have kaffe, mens den kører).Et andet fælles problem for udviklere er at opretholde et sikkert og sammenhængende miljø. Forestil dig at jeg installere komponent X (f.eks MySQL-database) og skriver et stykke kode, der bruger en nyinstalleret komponent. Nu skal jeg installere den samme komponent igen på produktionen server og fortælle alle andre udvikler til at installere den ellers vil koden knække.Den utrolige pinsel ved at oprette og vedligeholde udviklingsmiljøer tvinger nogle gange udviklere til at ignorere sikkerhedspolitikker, lave dobbelt arbejde og fokusere på de ting, de ikke var hyret til. Hos fadeit, tog vi en beslutning om ikke at gå igennem dette helvede, og det er derfor, vi har automatiseret de fleste af vores systemer med Puppet.",
    "EXPERTISE_EXPERIENCE_DESIGN_TITLE": "Experience Design",
    ...
    "EXPERTISE_OPEN_DATA_TITLE": "Open Data",
    "EXPERTISE_CKAN_DEVELOPMENT": "Åbenhed og gennemsigtighed er nøglen til den regering du gerne vil have. Hvis du skal bygge eller udvide et Open Data software, står vi til rådighed. Vi har stor expertise i forbindelse med at udvikle større <a href=\"http://ckan.org\">CKAN</a> portaler integreret med bl.a. Drupal infrastruktur.",
    "EXPERTISE_NODEJS_TITLE": "NodeJS Udvikling",
    "EXPERTISE_NODEJS_DEVELOPMENT": "Javascript afvikles ikke mere i din browser - NodeJS byder derimod på en model som er velegnet til web applikationer med data i real-time. Vi udvikler kommunikations applikationer med socket.io, custom moduler i forbindelse med Internet of Things routing software <a href=\"http://nodered.org\">Node-RED</a> og <a href=\"http://expressjs.com\">express.js</a> backends.",
    "EXPERTISE_WEB_CRAWLING_TITLE": "Web Crawlers",
